                ...
                <tbody class="divide-y divide-white/10">
                    ...
                    <tr class="hover:bg-white/5 transition">
                        ...
                        <td class="px-8 py-6 text-center">
                            <span class="px-5 py-2 rounded-full text-sm font-medium {{ $game->status == 'jugado' ? 'bg-green-500' : ($game->status == 'cancelado' ? 'bg-red-500' : 'bg-yellow-500') }}">
                                {{ ucfirst($game->status) }}
                            </span>
                        </td>
                        <td class="px-8 py-6 text-center">
                    ...
                    @empty
                    <tr><td colspan="7" class="px-8 py-20 text-center text-gray-400 text-lg">No hay partidos registrados</td></tr>
                    @endempty
                </tbody>
            </table>
        </div>
